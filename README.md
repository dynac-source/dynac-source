...
You can **download DYNAC and its Graphical User Interface DGUI** from the [DYNAC V7R3 download page](https://github.com/dynac-source/DYNAC-download?tab=readme-ov-file#dynac-v7r3-download). Please scroll down to the README section of that page, if this link doesn't take you there directly.  
